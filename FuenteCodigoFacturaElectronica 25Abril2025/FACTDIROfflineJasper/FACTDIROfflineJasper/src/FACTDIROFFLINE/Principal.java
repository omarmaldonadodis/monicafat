...
public class Principal extends JFrame {
    ...
    // NUEVO: reemplaza la última línea del textarea en lugar de agregar una nueva.
    // Usado para mostrar el progreso del batch sin llenar el log.
    public void ActualizarContador(String texto) {
        String contenidoActual = this.jTextArea1.getText();
        int ultimoSalto = contenidoActual.lastIndexOf("\n", contenidoActual.length() - 2);
        if (ultimoSalto >= 0) {
            this.jTextArea1.replaceRange(texto + " \n", ultimoSalto + 1, contenidoActual.length());
        } else {
                    ...
                    .addGroup(layout.createSequentialGroup().addGap(24, 24, 24)
                        .addGroup(layout.createParallelGroup(Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(this.jLabelFileNotAutorized)))
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(this.jLabel5, -2, 382, -2)))
                .addContainerGap()));
                ...
                .addGroup(layout.createParallelGroup(Alignment.TRAILING)
                    .addGroup(Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                            .addComponent(this.jLabel6)
                            .addComponent(this.jLabelFileNotAutorized)))
                    .addComponent(this.jLabel5, -2, 92, -2))
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(this.jScrollPane1, -1, 383, 32767)
                .addContainerGap()));
